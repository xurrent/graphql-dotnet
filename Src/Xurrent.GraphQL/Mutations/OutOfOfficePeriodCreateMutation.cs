...
namespace Xurrent.GraphQL
{
    ...
    /// </summary>
    internal sealed class OutOfOfficePeriodCreateMutation : Mutation<OutOfOfficePeriodCreatePayload, OutOfOfficePeriodCreateInput>
    {
        /// <summary>
        /// Initialize an new OutOfOfficePeriodCreate mutation instance.
        /// </summary>
        /// <param name="data">The input data.</param>
        /// <param name="query">The out of office period response query.</param>
