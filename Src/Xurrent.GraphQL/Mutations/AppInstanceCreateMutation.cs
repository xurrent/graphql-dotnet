...
namespace Xurrent.GraphQL
{
    ...
    /// </summary>
    internal sealed class AppInstanceCreateMutation : Mutation<AppInstanceCreatePayload, AppInstanceCreateInput>
    {
        /// <summary>
        /// Initialize an new AppInstanceCreate mutation instance.
        /// </summary>
        /// <param name="data">The input data.</param>
        /// <param name="query">The app instance response query.</param>
