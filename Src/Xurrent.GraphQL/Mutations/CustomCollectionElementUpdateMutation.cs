...
namespace Xurrent.GraphQL
{
    ...
    /// </summary>
    internal sealed class CustomCollectionElementUpdateMutation : Mutation<CustomCollectionElementUpdatePayload, CustomCollectionElementUpdateInput>
    {
        /// <summary>
        /// Initialize an new CustomCollectionElementUpdate mutation instance.
        /// </summary>
        /// <param name="data">The input data.</param>
        /// <param name="query">The custom collection element response query.</param>
