...
namespace Xurrent.GraphQL
{
    ...
    /// </summary>
    internal sealed class ServiceInstanceUpdateMutation : Mutation<ServiceInstanceUpdatePayload, ServiceInstanceUpdateInput>
    {
        /// <summary>
        /// Initialize an new ServiceInstanceUpdate mutation instance.
        /// </summary>
        /// <param name="data">The input data.</param>
        /// <param name="query">The service instance response query.</param>
