...
namespace Xurrent.GraphQL
{
    ...
    /// </summary>
    internal sealed class RequestTemplateUpdateMutation : Mutation<RequestTemplateUpdatePayload, RequestTemplateUpdateInput>
    {
        /// <summary>
        /// Initialize an new RequestTemplateUpdate mutation instance.
        /// </summary>
        /// <param name="data">The input data.</param>
        /// <param name="query">The request template response query.</param>
