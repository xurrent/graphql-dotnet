...
{
    /// <summary>
    /// Provides methods for bulk operations with the Xurrent API.
    /// </summary>
    public sealed class XurrentBulkClient
    {
        private readonly XurrentClient client;

        internal XurrentBulkClient(XurrentClient client)
        {
            this.client = client;
        }

        /// <summary>
        /// Starts a Xurrent CSV export.
        ...
        /// </param>
        /// <returns>A task representing the asynchronous operation, with a stream representing the file content.</returns>
        /// <exception cref="XurrentException">Thrown when the export fails.</exception>
        ...
        /// <exception cref="XurrentException">Thrown when the import process fails.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown when the polling interval is outside the allowed range.</exception>
