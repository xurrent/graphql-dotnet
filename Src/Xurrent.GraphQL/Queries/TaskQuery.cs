...
namespace Xurrent.GraphQL
{
    ...
    public class TaskQuery : Query<TaskQuery, TaskField, TaskView, TaskFilter, TaskOrderField>
    {
        ...
        /// <br>Additional information is available on the <see href="https://developer.xurrent.com/graphql/input_object/taskcustomfilter/">Xurrent developer site</see>.</br>
        /// </summary>
