...
namespace Xurrent.GraphQL
{
    ...
    public class ReleaseQuery : Query<ReleaseQuery, ReleaseField, ReleaseView, ReleaseFilter, ReleaseOrderField>
    {
        ...
        /// <br>Additional information is available on the <see href="https://developer.xurrent.com/graphql/input_object/releasecustomfilter/">Xurrent developer site</see>.</br>
        /// </summary>
