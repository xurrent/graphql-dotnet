...
namespace Xurrent.GraphQL
{
    ...
    public class SiteQuery : Query<SiteQuery, SiteField, SiteView, SiteFilter, SiteOrderField>
    {
        ...
        /// <br>Additional information is available on the <see href="https://developer.xurrent.com/graphql/input_object/sitecustomfilter/">Xurrent developer site</see>.</br>
        /// </summary>
