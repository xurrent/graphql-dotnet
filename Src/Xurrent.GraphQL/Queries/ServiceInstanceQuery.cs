...
namespace Xurrent.GraphQL
{
    ...
    public class ServiceInstanceQuery : Query<ServiceInstanceQuery, ServiceInstanceField, ServiceInstanceView, ServiceInstanceFilter, ServiceInstanceOrderField>
    {
        ...
        /// <br>Additional information is available on the <see href="https://developer.xurrent.com/graphql/input_object/serviceinstancecustomfilter/">Xurrent developer site</see>.</br>
        /// </summary>
