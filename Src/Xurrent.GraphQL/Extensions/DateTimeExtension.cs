...
namespace Xurrent.GraphQL
{
    ...
    public static class DateTimeExtension
    {
        ...
        /// <returns>Returns true when the value matches the predefined 'best effort' date time value (0001-01-01T01:01:01.111Z)</returns>
        ...
        /// </summary>
        /// <param name="dateTime">The date time object.</param>
        /// <returns>Returns true when the value matches the predefined 'no target' date time value (0002-02-02T02:02:02.222Z)</returns>
        ...
        /// </summary>
        /// <param name="dateTime">The date time object.</param>
        /// <returns>Returns true when the value matches the predefined 'clock stopped' date time value (0003-03-03T03:03:03.333Z)</returns>
