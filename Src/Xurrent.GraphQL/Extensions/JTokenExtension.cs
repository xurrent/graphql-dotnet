...
namespace Xurrent.GraphQL
{
    ...
    public static class JTokenExtension
    {
        ...
        private static JObject ToCamelCase(this JObject token)
        {
            ...
            {
                if (property.Name.Equals("nodeID", System.StringComparison.Ordinal) || (property.Name.Equals("id", System.StringComparison.Ordinal) && property.Value.Type == JTokenType.String))
                {
                    retval["id"] = property.Value;
                }
                else if (!property.Name.Equals("id", System.StringComparison.Ordinal))
                {
