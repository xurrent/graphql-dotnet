...
{
    /// <summary>
    /// An Xurrent GraphQL JSON interface converter.
    /// </summary>
    internal sealed class InterfaceConverter : JsonConverter
    {
        private Dictionary<string, Type> interfaceTypeMappings = new();

        /// <summary>
        /// A collection of GraphQL types to Xurrent SDK data types to convert interface properties.
        /// </summary>
        ...
        public override object? ReadJson(JsonReader reader, Type objectType, object? existingValue, JsonSerializer serializer)
        {
            ...
            {
                throw new XurrentException($"The GraphQL __typename value for property of the type {objectType.Name} is null and cannot be casted to a known data type.");
            }
            return null;
        }
