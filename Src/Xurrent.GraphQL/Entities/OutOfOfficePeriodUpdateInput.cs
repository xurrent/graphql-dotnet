...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/outofofficeperiodupdateinput/">OutOfOfficePeriodUpdateInput</see> object.
    /// </summary>
    public class OutOfOfficePeriodUpdateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OutOfOfficePeriodUpdateInput"/> class without providing the required values.
        /// </summary>
        public OutOfOfficePeriodUpdateInput()
        {
            id = string.Empty;
        }
