...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/appofferingcreateinput/">AppOfferingCreateInput</see> object.
    /// </summary>
    public class AppOfferingCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("serviceInstanceId"), XurrentField(IsRequiredForMutation = true)]
