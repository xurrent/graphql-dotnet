...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/surveyresponsecreateinput/">SurveyResponseCreateInput</see> object.
    /// </summary>
    public class SurveyResponseCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("surveyId"), XurrentField(IsRequiredForMutation = true)]
