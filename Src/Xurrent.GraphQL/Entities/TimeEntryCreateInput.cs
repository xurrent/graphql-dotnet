...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/timeentrycreateinput/">TimeEntryCreateInput</see> object.
    /// </summary>
    public class TimeEntryCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("timeSpent"), XurrentField(IsRequiredForMutation = true)]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeEntryCreateInput"/> class without providing the required values.
        /// </summary>
        public TimeEntryCreateInput()
        {
            timeSpent = default(long);
        }
