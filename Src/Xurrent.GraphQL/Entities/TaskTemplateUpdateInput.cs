...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/tasktemplateupdateinput/">TaskTemplateUpdateInput</see> object.
    /// </summary>
    public class TaskTemplateUpdateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskTemplateUpdateInput"/> class without providing the required values.
        /// </summary>
        public TaskTemplateUpdateInput()
        {
            id = string.Empty;
        }
