...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/tasktemplatecreateinput/">TaskTemplateCreateInput</see> object.
    /// </summary>
    public class TaskTemplateCreateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskTemplateCreateInput"/> class without providing the required values.
        /// </summary>
        public TaskTemplateCreateInput()
        {
            category = default(TaskCategory);
