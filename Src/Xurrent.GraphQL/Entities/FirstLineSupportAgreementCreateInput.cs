...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/firstlinesupportagreementcreateinput/">FirstLineSupportAgreementCreateInput</see> object.
    /// </summary>
    public class FirstLineSupportAgreementCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("customerId"), XurrentField(IsRequiredForMutation = true)]
        ...
        /// </summary>
        [JsonProperty("providerId"), XurrentField(IsRequiredForMutation = true)]
