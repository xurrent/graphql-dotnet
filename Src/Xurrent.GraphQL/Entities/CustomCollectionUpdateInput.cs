...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/customcollectionupdateinput/">CustomCollectionUpdateInput</see> object.
    /// </summary>
    public class CustomCollectionUpdateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomCollectionUpdateInput"/> class without providing the required values.
        /// </summary>
        public CustomCollectionUpdateInput()
        {
            id = string.Empty;
        }
