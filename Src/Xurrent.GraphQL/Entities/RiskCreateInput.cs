...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/riskcreateinput/">RiskCreateInput</see> object.
    /// </summary>
    public class RiskCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("severity"), XurrentField(IsRequiredForMutation = true)]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RiskCreateInput"/> class without providing the required values.
        /// </summary>
        public RiskCreateInput()
        {
