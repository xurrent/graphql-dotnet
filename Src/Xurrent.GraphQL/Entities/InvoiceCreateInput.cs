...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/invoicecreateinput/">InvoiceCreateInput</see> object.
    /// </summary>
    public class InvoiceCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("description"), XurrentField(IsRequiredForMutation = true)]
        ...
        /// </summary>
        [JsonProperty("invoiceDate"), XurrentField(IsRequiredForMutation = true)]
#if NET6_0_OR_GREATER
        ...
        /// </summary>
        [JsonProperty("invoiceNr"), XurrentField(IsRequiredForMutation = true)]
        ...
        /// </summary>
        [JsonProperty("quantity"), XurrentField(IsRequiredForMutation = true)]
        ...
        /// </summary>
        [JsonProperty("supplierId"), XurrentField(IsRequiredForMutation = true)]
        ...
        /// </summary>
        [JsonProperty("unitPrice"), XurrentField(IsRequiredForMutation = true)]
