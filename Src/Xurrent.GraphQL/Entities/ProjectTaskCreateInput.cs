...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/projecttaskcreateinput/">ProjectTaskCreateInput</see> object.
    /// </summary>
    public class ProjectTaskCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("phaseId"), XurrentField(IsRequiredForMutation = true)]
        ...
        /// </summary>
        [JsonProperty("projectId"), XurrentField(IsRequiredForMutation = true)]
