...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/object/configurationitemrelation/">ConfigurationItemRelation</see> object.
    /// </summary>
    public class ConfigurationItemRelation : Node
    {
        ...
        /// </summary>
        [JsonProperty("relationType"), XurrentField(IsDefaultQueryProperty = true)]
