...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/reservationcreateinput/">ReservationCreateInput</see> object.
    /// </summary>
    public class ReservationCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("configurationItemId"), XurrentField(IsRequiredForMutation = true)]
        ...
        /// </summary>
        [JsonProperty("reservationOfferingId"), XurrentField(IsRequiredForMutation = true)]
