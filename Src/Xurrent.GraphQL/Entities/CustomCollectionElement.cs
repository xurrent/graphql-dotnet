...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/object/customcollectionelement/">CustomCollectionElement</see> object.
    /// </summary>
    public class CustomCollectionElement : Node, IHasTranslations
    {
        ...
        /// </summary>
        [JsonProperty("reference"), XurrentField(IsDefaultQueryProperty = true)]
