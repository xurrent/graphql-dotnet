...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/projectcreateinput/">ProjectCreateInput</see> object.
    /// </summary>
    public class ProjectCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("justification"), XurrentField(IsRequiredForMutation = true)]
