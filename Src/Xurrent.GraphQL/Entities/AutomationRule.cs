...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/object/automationrule/">AutomationRule</see> object.
    /// </summary>
    public class AutomationRule : Node
    {
        ...
        /// </summary>
        [JsonProperty("actions"), XurrentField(IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [JsonProperty("condition"), XurrentField(IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [JsonProperty("generic"), XurrentField(IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [JsonProperty("trigger"), XurrentField(IsDefaultQueryProperty = true)]
