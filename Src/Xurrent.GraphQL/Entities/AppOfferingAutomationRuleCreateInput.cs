...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/appofferingautomationrulecreateinput/">AppOfferingAutomationRuleCreateInput</see> object.
    /// </summary>
    public class AppOfferingAutomationRuleCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("condition"), XurrentField(IsRequiredForMutation = true)]
        ...
        /// </summary>
        [JsonProperty("trigger"), XurrentField(IsRequiredForMutation = true)]
