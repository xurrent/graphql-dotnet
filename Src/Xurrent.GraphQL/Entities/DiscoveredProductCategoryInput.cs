...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/discoveredproductcategoryinput/">DiscoveredProductCategoryInput</see> object.
    /// </summary>
    public class DiscoveredProductCategoryInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("reference"), XurrentField(IsRequiredForMutation = true)]
