...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/shorturlemailinput/">ShortUrlEmailInput</see> object.
    /// </summary>
    public class ShortUrlEmailInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("to"), XurrentField(IsRequiredForMutation = true)]
        public string To
        {
            get => to;
            set => to = Set("to", value);
