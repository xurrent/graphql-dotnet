...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/sprintcreateinput/">SprintCreateInput</see> object.
    /// </summary>
    public class SprintCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("scrumWorkspaceId"), XurrentField(IsRequiredForMutation = true)]
