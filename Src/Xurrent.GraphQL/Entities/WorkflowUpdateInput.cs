...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/workflowupdateinput/">WorkflowUpdateInput</see> object.
    /// </summary>
    public class WorkflowUpdateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowUpdateInput"/> class without providing the required values.
        /// </summary>
        public WorkflowUpdateInput()
        {
            id = string.Empty;
        }
