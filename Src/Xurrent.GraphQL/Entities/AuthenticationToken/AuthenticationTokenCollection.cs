...
{
    /// <summary>
    /// A Xurrent authentication token collection.
    /// </summary>
    public sealed class AuthenticationTokenCollection : IEnumerable<AuthenticationToken>
    {
        ...
        /// </para>
        /// <para>To find additional information regarding Service Quotas, please refer to the <see href="https://developer.xurrent.com/graphql/#service-quotas-1">Xurrent developer documentation</see>.</para>
        /// </summary>
        ...
        /// <summary>
        /// Returns the Xurrent authentication token with the highest remaining request and/or cost.
        /// </summary>
        ...
        public AuthenticationToken Get()
        {
            if (authenticationTokens.Count.Equals(0))
                throw new XurrentTokenNullReferenceException("The collection does not contain any token.");
        ...
        /// </summary>
        /// <param name="authenticationToken">The Xurrent Personal Access Token.</param>
        ...
        /// </summary>
        /// <param name="clientID">The Xurrent OAuth 2.0 client grant client ID.</param>
        /// <param name="clientSecret">The Xurrent OAuth 2.0 client grant client secret.</param>
        ...
        /// Create a new instance of an <see cref="AuthenticationTokenCollection"/>.
        /// </summary>
        /// <param name="authenticationToken">A Xurrent authentication token to add to the collection.</param>
        ...
        /// <summary>
        /// Add a Xurrent Personal Access Token to the collection.
        /// </summary>
        /// <param name="authenticationToken">The Xurrent Personal Access Token.</param>
        ...
        /// <summary>
        /// Add a Xurrent OAuth 2.0 client grant credential to the collection.
        /// </summary>
        /// <param name="clientID">The Xurrent OAuth 2.0 client grant client ID.</param>
        /// <param name="clientSecret">The Xurrent OAuth 2.0 client grant client secret.</param>
        ...
        /// <summary>
        /// Adds a Xurrent authentication token to the collection.
        /// </summary>
        ...
        public void Add(AuthenticationToken authenticationToken)
        {
            if (authenticationToken is null)
                throw new XurrentTokenNullReferenceException(nameof(authenticationToken));
            ...
            if (string.IsNullOrWhiteSpace(authenticationToken.Token) && (string.IsNullOrWhiteSpace(authenticationToken.ClientID) || string.IsNullOrWhiteSpace(authenticationToken.ClientSecret)))
                throw new XurrentTokenNullReferenceException($"Missing Client ID and Client Secret, or Personal Access Token.");
        ...
        /// <summary>
        /// Removes a Xurrent authentication token from the collection.
        /// </summary>
        /// <param name="authenticationToken">The Xurrent authentication token.</param>
