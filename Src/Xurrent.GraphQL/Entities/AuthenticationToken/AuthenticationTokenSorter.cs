...
{
    /// <summary>
    /// Compares two Xurrent authentication tokens and sort them by remaining API requests.
    /// </summary>
    public sealed class AuthenticationTokenSorter : IComparer<AuthenticationToken>
    {
        ...
        /// <summary>
        /// Compares two Xurrent authentication and returns sort them by remaining API requests and limit values.
        /// </summary>
        ...
        /// <summary>
        /// Calculates a score for a Xurrent authentication token based on the remaining requests and cost.
        /// </summary>
