...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/discoveredproductinput/">DiscoveredProductInput</see> object.
    /// </summary>
    public class DiscoveredProductInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("brand"), XurrentField(IsRequiredForMutation = true)]
        public string Brand
        {
            get => brand;
        ...
        /// </summary>
        [JsonProperty("model"), XurrentField(IsRequiredForMutation = true)]
        public string Model
        {
            get => model;
        ...
        /// </summary>
        [JsonProperty("sourceID"), XurrentField(IsRequiredForMutation = true)]
