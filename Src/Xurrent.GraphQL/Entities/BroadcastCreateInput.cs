...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/broadcastcreateinput/">BroadcastCreateInput</see> object.
    /// </summary>
    public class BroadcastCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("messageType"), XurrentField(IsRequiredForMutation = true)]
