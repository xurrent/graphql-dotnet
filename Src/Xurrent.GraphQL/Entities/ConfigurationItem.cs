...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/object/configurationitem/">ConfigurationItem</see> object.
    /// </summary>
    public class ConfigurationItem : Node
    {
        ...
        /// </summary>
        [JsonProperty("assetID"), XurrentField(IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [JsonProperty("ruleSet"), XurrentField(IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [JsonProperty("serialNr"), XurrentField(IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [JsonProperty("systemID"), XurrentField(IsDefaultQueryProperty = true)]
