...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/appinstancecreateinput/">AppInstanceCreateInput</see> object.
    /// </summary>
    public class AppInstanceCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("appOfferingId"), XurrentField(IsRequiredForMutation = true)]
        ...
        /// </summary>
        [JsonProperty("customerAccountId"), XurrentField(IsRequiredForMutation = true)]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AppInstanceCreateInput"/> class without providing the required values.
        /// </summary>
        public AppInstanceCreateInput()
        {
