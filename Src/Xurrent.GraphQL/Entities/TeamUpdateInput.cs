...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/teamupdateinput/">TeamUpdateInput</see> object.
    /// </summary>
    public class TeamUpdateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamUpdateInput"/> class without providing the required values.
        /// </summary>
        public TeamUpdateInput()
        {
            id = string.Empty;
        }
