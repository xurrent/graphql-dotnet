...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/object/projecttasktemplate/">ProjectTaskTemplate</see> object.
    /// </summary>
    public class ProjectTaskTemplate : Node, IHasAutomationRules
    {
        ...
        /// </summary>
        [JsonProperty("category"), XurrentField(IsDefaultQueryProperty = true)]
