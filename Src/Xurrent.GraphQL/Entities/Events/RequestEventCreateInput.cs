...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/v1/requests/events/">event</see> input object.
    /// </summary>
    public class RequestEventCreateInput
    {
        ...
        public RequestEventCreateInput ConfigurationItem(ConfigurationItem configurationItem)
        {
            ...
            else if (configurationItem.Source != null && !string.IsNullOrEmpty(configurationItem.Source) && configurationItem.SourceID != null && !string.IsNullOrEmpty(configurationItem.SourceID))
            {
            ...
            {
                throw new XurrentException("The configuration item ID, or source and sourceID, are null or empty.");
        ...
        public RequestEventCreateInput Member(Person person)
        {
            ...
            else if (person.PrimaryEmail != null && !string.IsNullOrEmpty(person.PrimaryEmail))
            {
                AddToRequest("member", person.PrimaryEmail);
            }
            else
            {
                throw new XurrentException("The person ID and primary email address are null or empty.");
            }
            return this;
        }
        ...
        public RequestEventCreateInput Problem(Problem problem)
        {
            ...
            {
                throw new XurrentException("The problem ID is null or empty.");
            }
            return this;
        }
        ...
        public RequestEventCreateInput ServiceInstance(ServiceInstance serviceInstance)
        {
            ...
            else if (serviceInstance.Name != null && !string.IsNullOrEmpty(serviceInstance.Name))
            {
                AddToRequest("service_instance", serviceInstance.Name);
            }
            else
            {
                throw new XurrentException("The service instance ID and name are null or empty.");
            }
            return this;
        }
        ...
        public RequestEventCreateInput Supplier(Organization supplier)
        {
            ...
            else if (supplier.Name != null && !string.IsNullOrEmpty(supplier.Name))
            {
        ...
        public RequestEventCreateInput Team(Team team)
        {
            ...
            else if (team.Name != null && !string.IsNullOrEmpty(team.Name))
            {
                AddToRequest("team", team.Name);
            }
            else
            {
                throw new XurrentException("The team ID and name are null or empty.");
            }
            return this;
        }
        ...
        public RequestEventCreateInput RequestTemplate(RequestTemplate requestTemplate)
        {
            ...
            {
                throw new XurrentException("The request template ID is null or empty.");
            }
            return this;
        }
        ...
        public RequestEventCreateInput Workflow(Workflow workflow)
        {
            ...
            {
                throw new XurrentException("The workflow ID is null or empty.");
            }
            return this;
        }
