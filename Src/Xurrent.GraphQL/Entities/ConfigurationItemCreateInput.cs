...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/configurationitemcreateinput/">ConfigurationItemCreateInput</see> object.
    /// </summary>
    public class ConfigurationItemCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("productId"), XurrentField(IsRequiredForMutation = true)]
        ...
        /// </summary>
        [JsonProperty("status"), XurrentField(IsRequiredForMutation = true)]
