...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/riskseverityupdateinput/">RiskSeverityUpdateInput</see> object.
    /// </summary>
    public class RiskSeverityUpdateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RiskSeverityUpdateInput"/> class without providing the required values.
        /// </summary>
        public RiskSeverityUpdateInput()
        {
            id = string.Empty;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="RiskSeverityUpdateInput"/> class.
        /// </summary>
        /// <param name="id">The node ID of the record to update.</param>
        public RiskSeverityUpdateInput(string id)
        {
            this.id = Set("id", id);
        }
    }
