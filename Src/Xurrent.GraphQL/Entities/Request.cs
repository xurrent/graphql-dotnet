...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/object/request/">Request</see> object.
    /// </summary>
    public class Request : Node, IHasAutomationRules, IHasLifeCycleState, IHasNotes, IHasSprintBacklogItems, IHasTimeEntries
    {
        ...
        /// </summary>
        [JsonProperty("completionReason"), XurrentField(IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [JsonProperty("requestId"), XurrentField(IsDefaultQueryProperty = true)]
