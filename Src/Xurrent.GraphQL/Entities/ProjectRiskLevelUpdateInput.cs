...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/projectrisklevelupdateinput/">ProjectRiskLevelUpdateInput</see> object.
    /// </summary>
    public class ProjectRiskLevelUpdateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectRiskLevelUpdateInput"/> class without providing the required values.
        /// </summary>
        public ProjectRiskLevelUpdateInput()
        {
            id = string.Empty;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectRiskLevelUpdateInput"/> class.
        /// </summary>
        /// <param name="id">The node ID of the record to update.</param>
        public ProjectRiskLevelUpdateInput(string id)
        {
            this.id = Set("id", id);
        }
    }
