...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/servicelevelagreementcreateinput/">ServiceLevelAgreementCreateInput</see> object.
    /// </summary>
    public class ServiceLevelAgreementCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("serviceOfferingId"), XurrentField(IsRequiredForMutation = true)]
