...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/serviceofferingcreateinput/">ServiceOfferingCreateInput</see> object.
    /// </summary>
    public class ServiceOfferingCreateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceOfferingCreateInput"/> class without providing the required values.
        /// </summary>
        public ServiceOfferingCreateInput()
        {
            name = string.Empty;
