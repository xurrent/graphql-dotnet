...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/taskcreateinput/">TaskCreateInput</see> object.
    /// </summary>
    public class TaskCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("workflowId"), XurrentField(IsRequiredForMutation = true)]
