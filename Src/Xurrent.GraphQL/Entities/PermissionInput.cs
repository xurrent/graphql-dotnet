...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/permissioninput/">PermissionInput</see> object.
    /// </summary>
    public class PermissionInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("accountId"), XurrentField(IsRequiredForMutation = true)]
