...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/slacoveragegroupupdateinput/">SlaCoverageGroupUpdateInput</see> object.
    /// </summary>
    public class SlaCoverageGroupUpdateInput : PropertyChangeSet
    {
        ...
        public SlaCoverageGroupUpdateInput(string id)
        {
            this.id = Set("id", id);
        }
    }
