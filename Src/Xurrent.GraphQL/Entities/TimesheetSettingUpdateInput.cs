...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/timesheetsettingupdateinput/">TimesheetSettingUpdateInput</see> object.
    /// </summary>
    public class TimesheetSettingUpdateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TimesheetSettingUpdateInput"/> class without providing the required values.
        /// </summary>
        public TimesheetSettingUpdateInput()
        {
            id = string.Empty;
        }
