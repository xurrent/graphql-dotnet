...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/shoporderlinecreateinput/">ShopOrderLineCreateInput</see> object.
    /// </summary>
    public class ShopOrderLineCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("requestedForId"), XurrentField(IsRequiredForMutation = true)]
        ...
        /// </summary>
        [JsonProperty("shopArticleId"), XurrentField(IsRequiredForMutation = true)]
