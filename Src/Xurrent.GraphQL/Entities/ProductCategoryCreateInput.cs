...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/productcategorycreateinput/">ProductCategoryCreateInput</see> object.
    /// </summary>
    public class ProductCategoryCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("ruleSet"), XurrentField(IsRequiredForMutation = true)]
        ...
        {
            name = string.Empty;
            ruleSet = default(ProductCategoryRuleSet);
        }
