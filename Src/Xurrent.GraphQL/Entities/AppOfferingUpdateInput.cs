...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/appofferingupdateinput/">AppOfferingUpdateInput</see> object.
    /// </summary>
    public class AppOfferingUpdateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AppOfferingUpdateInput"/> class without providing the required values.
        /// </summary>
        public AppOfferingUpdateInput()
        {
            id = string.Empty;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="AppOfferingUpdateInput"/> class.
        /// </summary>
        /// <param name="id">The node ID of the record to update.</param>
        public AppOfferingUpdateInput(string id)
        {
            this.id = Set("id", id);
        }
    }
