...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/timesheetsettingcreateinput/">TimesheetSettingCreateInput</see> object.
    /// </summary>
    public class TimesheetSettingCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("unit"), XurrentField(IsRequiredForMutation = true)]
