...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/object/person/">Person</see> object.
    /// </summary>
    public class Person : Node, IHasLifeCycleState
    {
        ...
        /// </summary>
        [JsonProperty("authenticationID"), XurrentField(IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [JsonProperty("employeeID"), XurrentField(IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [JsonProperty("primaryEmail"), XurrentField(IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [JsonProperty("supportID"), XurrentField(IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [JsonProperty("vip"), XurrentField(IsDefaultQueryProperty = true)]
