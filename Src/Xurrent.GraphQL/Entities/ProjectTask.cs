...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/object/projecttask/">ProjectTask</see> object.
    /// </summary>
    public class ProjectTask : Node, IHasAutomationRules, IHasLifeCycleState, IHasNotes, IHasSprintBacklogItems, IHasTimeEntries
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("completionTargetAt")]
