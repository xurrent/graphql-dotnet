...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/object/recurrence/">Recurrence</see> object.
    /// </summary>
    ...
    public class Recurrence : Node
    {
        ...
        /// </summary>
        [JsonProperty("endDate"), XurrentField(IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [JsonProperty("ical"), XurrentField(IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [JsonProperty("lastOccurrenceAt"), XurrentField(IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [JsonProperty("lastOccurrenceErrors"), XurrentField(IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [JsonProperty("nextOccurrenceAt"), XurrentField(IsDefaultQueryProperty = true)]
        public DateTime? NextOccurrenceAt { get; internal set; }

        /// <summary>
        /// The date at which to start the Recurrence.
        /// </summary>
        [JsonProperty("startDate"), XurrentField(IsDefaultQueryProperty = true)]
#if NET6_0_OR_GREATER
