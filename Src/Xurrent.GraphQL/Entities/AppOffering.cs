...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/object/appoffering/">AppOffering</see> object.
    /// </summary>
    public class AppOffering : Node
    {
        ...
        /// </summary>
        [JsonProperty("latest"), XurrentField(IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [JsonProperty("published"), XurrentField(IsDefaultQueryProperty = true)]
