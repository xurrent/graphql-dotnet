...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/shoparticleupdateinput/">ShopArticleUpdateInput</see> object.
    /// </summary>
    public class ShopArticleUpdateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShopArticleUpdateInput"/> class without providing the required values.
        /// </summary>
        public ShopArticleUpdateInput()
        {
            id = string.Empty;
        }
