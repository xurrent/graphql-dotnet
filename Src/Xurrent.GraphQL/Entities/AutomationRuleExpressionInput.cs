...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/automationruleexpressioninput/">AutomationRuleExpressionInput</see> object.
    /// </summary>
    public class AutomationRuleExpressionInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("value"), XurrentField(IsRequiredForMutation = true)]
        public string Value
        {
            get => value;
