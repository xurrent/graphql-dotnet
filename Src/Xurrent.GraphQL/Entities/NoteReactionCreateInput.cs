...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/notereactioncreateinput/">NoteReactionCreateInput</see> object.
    /// </summary>
    public class NoteReactionCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("noteId"), XurrentField(IsRequiredForMutation = true)]
        ...
        /// <br>• ❤️</br>
        /// </summary>
        [JsonProperty("reaction"), XurrentField(IsRequiredForMutation = true)]
