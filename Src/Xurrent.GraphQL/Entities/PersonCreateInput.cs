...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/personcreateinput/">PersonCreateInput</see> object.
    /// </summary>
    public class PersonCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("primaryEmail"), XurrentField(IsRequiredForMutation = true)]
