...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/object/contact/">Contact</see> object.
    /// </summary>
    public class Contact : Node
    {
        ...
        /// </summary>
        [JsonProperty("protocol"), XurrentField(IsDefaultQueryProperty = true)]
        public ContactProtocol? Protocol { get; internal set; }

        /// <summary>
        /// The telephone number, email address, etc.
        /// </summary>
        [JsonProperty("uri"), XurrentField(IsDefaultQueryProperty = true)]
