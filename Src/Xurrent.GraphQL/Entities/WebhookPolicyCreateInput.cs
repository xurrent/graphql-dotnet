...
{
    /// <summary>
    /// The <see href="https://developer.xurrent.com/graphql/input_object/webhookpolicycreateinput/">WebhookPolicyCreateInput</see> object.
    /// </summary>
    public class WebhookPolicyCreateInput : PropertyChangeSet
    {
        ...
        /// </summary>
        [JsonProperty("jwtAlg"), XurrentField(IsRequiredForMutation = true)]
